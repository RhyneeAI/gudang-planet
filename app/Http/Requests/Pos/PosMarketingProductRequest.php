...
class PosMarketingProductRequest extends FormRequest
{
    ...
    public function after(): array
    {
        return [
            function ($validator) {
                ...
                $query = PosMarketingProduct::where('product_id', $productId)
    ...
    public function getProductId(): ?int
    {
        ...
        return $this->resolvedProductId ??= PosProduct::where('uuid', $this->product_uuid)
            ->value('id');
    }
